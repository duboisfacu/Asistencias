...
Public Class ProfesoresGrid
        ...
        Try
            For Each row As DataGridViewRow In DataGridView2.Rows
                If row.Cells(1).Value Is Nothing Then
                    ...
                    Exit For
                Else
                    prof.legajo = DataGridView2.CurrentRow.Cells("Legajo").Value
                    prof.Borrar(prof.legajo)
                    prof.Listar(DataGridView2)
                    Exit For
                End If
            Next
    ...
    Private Sub Modificar()
        Try
            For Each row As DataGridViewRow In DataGridView2.Rows
                ...
                Else
                    prof.legajo = DataGridView2.CurrentRow.Cells("Legajo").Value
                    prof.nombre = DataGridView2.CurrentRow.Cells("Nombre").Value
                    Dim cargar_profesor As New Cargar_Profesor(prof)
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Dim cmd1 As New OleDbCommand("select * from profesor where nombre like '%" + TextBox1.Text + "%' or legajo like '%" + TextBox1.Text + "%'", conn)
