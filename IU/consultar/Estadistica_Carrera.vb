...
Public Class Estadistica_Carrera
    ...
    Public nomcarr As String
    Public añocarr As String
    ...
    Private Sub Estadistica_Carrera_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If nomcarr.Length > 37 Then
            lbl_nomcarr.Font = New Font("Calibri", 15)
        Else
            lbl_nomcarr.Font = New Font("Calibri", 18)
        End If
        ...
        Dim cadenacomprobante As String = "select * from Listado where IdCarrera = " + CStr(idcarr) + ""
        ...
        Dim cadenacomprobante2 As String = "select * from Listado where IdCarrera = " + CStr(idcarr) + " and Presente = True"
        ...
        End If
        Dim cadenacomprobante3 As String = "select * from Asistencia where IdCarrera = " + CStr(idcarr) + ""
        ...
        lbl_procentaje.Text = ("El porcentaje de asistencia de la carrera es de " + CStr(Math.Truncate(CInt(porcentaje))) + ("%"))
        Label1.Text = (CStr(Math.Truncate(CInt(porcentaje))) + ("%"))
        lbl_nomcarr.Text = nomcarr
        lbl_total.Text = ("Esta carrera lleva " + contador3 + " clases dadas en " + añocarr)
        con.Close()
